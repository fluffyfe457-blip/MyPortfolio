...
const socialLinks = [
  ...
  { name: "Stack Overflow", icon: "M15 21h-10v-2h10v2zm6-11.665l-1.621-9.335-1.993.346 1.62 9.335 1.994-.346zm-5.964 6.937l-9.746-.975-.186 2.016 9.755.879.177-1.92zm.538-2.587l-9.276-2.608-.526 1.954 9.306 2.5.496-1.846zm1.204-2.413l-8.297-4.864-1.029 1.743 8.298 4.865 1.028-1.744zm1.866-1.467l-5.339-7.829-1.672 1.14 5.339 7.829 1.672-1.14zm-2.644 4.195v8h-12v-8h-2v10h16v-10h-2z" },
]
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-center text-center">
        ...
        >
          ...
          opportunities, technical challenges, or ways to build something great together.
        </motion.p>
        ...
        >
          {socialLinks.map((social, index) => (
            ...
            >
              {/* Glow effect */}
              <motion.div
                className="absolute inset-0 rounded-full bg-accent/20 opacity-0 blur-md transition-opacity group-hover:opacity-100"
              />
              <svg 
                width="18" 
                height="18" 
              ...
              {/* Tooltip */}
              <motion.span
                className="absolute -top-10 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-foreground px-2 py-1 text-xs text-background opacity-0 transition-opacity group-hover:opacity-100"
              >
                {social.name}
              </motion.span>
            </motion.a>
        ...
        >
          <p className="text-xs uppercase tracking-widest text-muted-foreground">
            © 2025 John Doe. Crafted with care.
          </p>
        </motion.div>
      </div>
    </section>
